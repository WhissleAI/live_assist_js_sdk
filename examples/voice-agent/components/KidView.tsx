...
export default function KidView({ asrUrl, session, updateSession, sessionRef, settings }: Props) {
  ...
  const { start: startAsr, stop: stopAsr } = useAsrSession(asrUrl, sessionRef, updateSession, {
    onUtteranceFlush: handleUtteranceFlush,
    onSpeechStart: onChildSpeechStart,
    onSpeechEnd: onChildSpeechEnd,
  });
