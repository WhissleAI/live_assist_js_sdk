...
export default function MicButton({ isActive, isConnected, emotion, onToggle, primaryColor }: Props) {
  const ringColor = isActive
    ? (RING_COLORS[emotion] || primaryColor || RING_COLORS.NEUTRAL)
    : (primaryColor || "#4b5563");
  ...
  return (
    ...
    >
      ...
      <span className="mic-button-inner" style={isActive ? { boxShadow: `0 0 40px ${ringColor}40` } : undefined}>
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={isActive ? 2 : 2.5} strokeLinecap="round" strokeLinejoin="round">
