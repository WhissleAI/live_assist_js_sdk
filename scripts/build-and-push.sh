...
if [ "$PUSH" = true ]; then
  ...
  echo "   docker run -d --name live-assist \\"
  echo "     -p 8001:8001 -p 8765:8765 -p 5174:5174 \\"
  echo "     -e GEMINI_API_KEY=xxx \\"
  echo "     -e RIME_API_KEY=xxx \\"
  echo "     whissleasr/live-assist:latest"
  echo ""
  ...
  echo "   docker run -d --name live-assist --gpus all \\"
  echo "     -p 8001:8001 -p 8765:8765 -p 5174:5174 \\"
  echo "     -e GEMINI_API_KEY=xxx \\"
  echo "     -e RIME_API_KEY=xxx \\"
  ...
  echo ""
  echo "   Endpoints:"
  echo "     ASR WebSocket:     ws://localhost:8001/asr/stream"
  echo "     Agent API:         http://localhost:8765"
  echo "     Timeline Demo:     http://localhost:8765"
  echo "     Voice Agent UI:    http://localhost:5174"
else
  echo ""
